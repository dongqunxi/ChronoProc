...
def cal_labelts(stcs_path, condition='LLst', min_subject='fsaverage'):
    ...
    for stcs_path in path_list:
        ...
        while i < trials:
            ...
            i = i + 1
        # Get common labels
        list_file = minpath + '/dSPM_ROIs/ROIs/label_list.txt'
...
def sig_thresh(cau_list, condition=None, sfreq=678, alpha=0.01, factor=1, min_subject='fsaverage'):
...
def group_causality(sig_list, condition=None, min_subject='fsaverage', submount=10):
